        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workflows_IncidentTypes_IncidentTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeptHeadId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncidentDepartmentId = table.Column<int>(type: "int", nullable: false),
                    IncidentTypeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incidents_AspNetUsers_ReporterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowTasks_AspNetUsers_AssigneeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkFlowtaskExecutions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkFlowtaskExecutions_Incidents_IncidentId",
                        column: x => x.IncidentId,
                        principalTable: "Incidents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workflows_IncidentTypeId",
                table: "Workflows",
                column: "IncidentTypeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WorkFlowtaskExecutions_IncidentId",
                table: "WorkFlowtaskExecutions",
                column: "IncidentId");
